...
RUN apt-get update; apt-get install -y --no-install-recommends libpq-dev vim nginx php8.3-fpm php8.3-mbstring php8.3-xml php8.3-pgsql php8.3-curl ca-certificates cron
