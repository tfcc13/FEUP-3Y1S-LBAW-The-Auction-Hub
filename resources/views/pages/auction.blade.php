            ...
            <div class="flex flex-col lg:flex-row gap-6">
                ...
                <div class="flex-1 bg-white shadow-md rounded p-6">
                    ...
                    <div class="mt-4 text-gray-500 space-y-2">
                        <p>Start Price: <span class="font-semibold">${{ number_format($auction->start_price, 2) }}</span>
                        </p>
                        <p>Current Bid:
                        ...
                        <p>Category: <span class="font-semibold">{{ $auction->categoryName() ?? 'Uncategorized' }}</span>
                        </p>
                        <p>Start Date:
