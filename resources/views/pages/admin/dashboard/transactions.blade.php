            ...
            @if($transaction->state === 'Pending')
                <form action="{{ route('admin.transactions.approve', $transaction->id) }}" method="POST" class="inline-block approve-form">
                    ...
                    <x-toast.confirm
                      ...
                      :method="'PATCH'"
                      :id="'transaction-approve' . $transaction->id"
                      :modalTitle="'Approve '.$transaction->type.'?'"
                      :modalMessage="'Reference doesnt match are you sure you want to approve this transaction?'"
                      :object="$transaction" />
                    @else
