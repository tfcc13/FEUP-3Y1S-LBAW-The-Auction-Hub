...
@section('content')
    <div class="flex flex-col max-w-md mx-auto space-y-5">
        ...
        <a href="{{ route('google-auth') }}">
            <button class="w-full flex justify-center bg-white dark:bg-gray-900 border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 dark:text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
