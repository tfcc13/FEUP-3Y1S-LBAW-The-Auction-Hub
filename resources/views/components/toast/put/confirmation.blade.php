<div>
    ...
    <div>
        <button id="{{ 'confirmationButton' . $idName }}" class="px-4 py-2 text-white rounded"
            style="background-color: #135d3b; hover:bg-opacity-80;">
            {{ $buttonName }}
        </button>
    </div>


    <div id="{{ 'confirmationModal' . $idName }}"
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg w-96">
            ...
            <form action="{{ route($route, ['id' => $object->id]) }}" method="POST" class="w-full">
                ...
                <div class="flex justify-end space-x-4">
                    <button type="button" id="{{ 'cancelButton' . $idName }}"
