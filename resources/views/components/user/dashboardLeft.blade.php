...
<div class="lg:m-5">
  ...
  <div>
    ...
    <p>{{ auth()->user()->description ?? 'No description set' }}</p>
    <button class="px-3 py-2 rounded-md border border-gray-300 bg-[#135d3b]" data-modal-toggle="edit-description-modal">
      Change Description
    </button>
  </div>
</div>
