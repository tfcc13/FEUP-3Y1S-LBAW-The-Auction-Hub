<nav class="bg-[#135d3b]">
    <div class="w-full flex flex-wrap items-center justify-between p-4 ml-0 mr-0">
        <a href="{{ url('/home') }}" class="flex items-center space-x-3 rtl:space-x-reverse">
            <span class="self-center sm:text-2xl font-semibold whitespace-nowrap dark:text-white">The Auction Hub</span>
        </a>

        <button data-collapse-toggle="navbar-default" type="button"
            class="bg-[#0ff290] inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="font-medium flex flex-col p-4 md:p-0 sm:mr-8 mt-4 md:flex-row md:space-x-8 rtl:space-x-reverse">
                ...
                <li class="flex items-center justify-center">
                    <a href="#"
                        class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Following</a>
                </li>
                <li>
                    @if (Auth::check())
