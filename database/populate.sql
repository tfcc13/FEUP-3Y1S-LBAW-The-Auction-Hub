...
('john.doe@example.com', 'johndoe', 'John Doe', 'hashedpassword123', '1990-01-01', 50000, FALSE, 'Active', 4),
...
('carol.taylor@example.com', 'carolt', 'Carol Taylor', 'hashedpassword123', '1995-07-30', 50000, FALSE, 'Active', 2),
('david.brown@example.com', 'davidb', 'David Brown', 'hashedpassword123', '1982-09-05', 50000, FALSE, 'Active', 5),
('emma.davis@example.com', 'emmad', 'Emma Davis', 'hashedpassword123', '1993-12-18', 50000, FALSE, 'Active', 4),
('frank.miller@example.com', 'frankm', 'Frank Miller', 'hashedpassword123', '1987-06-25', 95000, FALSE, 'Active', 3),
('grace.lee@example.com', 'gracel', 'Grace Lee', 'hashedpassword123', '1991-04-30', 60000, FALSE, 'Active', 5),
('henry.wang@example.com', 'henryw', 'Henry Wang', 'hashedpassword123', '1989-02-14', 100100, FALSE, 'Active', 4),
('isabel.garcia@example.com', 'isabelg', 'Isabel Garcia', 'hashedpassword123', '1994-09-08', 70000, FALSE, 'Active', 3),
('jack.robinson@example.com', 'jackr', 'Jack Robinson', 'hashedpassword123', '1986-11-30', 85000, FALSE, 'Active', 5),
('karen.white@example.com', 'karenw', 'Karen White', 'hashedpassword123', '1993-07-22', 40000, FALSE, 'Active', 2),
...
-- Populate Auctions
INSERT INTO auction (title, description, start_price, current_bid, start_date, end_date, state, owner_id) VALUES
('Vintage Car Auction', 'Auction for a vintage car', 5000, NULL, '2024-10-10 10:00:00', NULL, 'Ongoing', 1),
('Antique Painting Auction', 'Rare antique painting', 2000, NULL, '2024-10-15 12:00:00', NULL, 'Ongoing', 2),
('Rare Comic Book Collection', 'Collection of rare comic books', 3000, NULL, '2024-10-20 09:00:00', NULL, 'Ongoing', 4),
('Diamond Necklace', 'Exquisite diamond necklace', 10000, NULL, '2024-10-25 14:00:00', NULL, 'Ongoing', 5),
('Signed Football Jersey', 'Jersey signed by famous player', 1500, NULL, '2024-11-01 11:00:00', NULL, 'Ongoing', 6),
('Antique Clock', 'Rare antique grandfather clock', 4000, NULL, '2024-11-05 13:00:00', NULL, 'Ongoing', 7),
('Vintage Camera', 'Classic film camera from the 1960s', 1200, NULL, '2024-11-10 10:00:00', NULL, 'Ongoing', 8),
('First Edition Book', 'Rare first edition of a classic novel', 2500, NULL, '2024-11-15 15:00:00', NULL, 'Ongoing', 9),
('Designer Handbag', 'Limited edition designer handbag', 3500, NULL, '2024-11-20 12:00:00', NULL, 'Ongoing', 10),
('Vintage Record Player', 'Fully restored vintage record player', 1800, NULL, '2024-11-25 14:00:00', NULL, 'Ongoing', 1),
('Rare Stamp Collection', 'Comprehensive collection of rare stamps', 7500, NULL, '2024-12-01 09:00:00', NULL, 'Ongoing', 11),
('Antique Furniture Set', 'Complete set of Victorian-era furniture', 15000, NULL, '2024-12-05 11:00:00', NULL, 'Ongoing', 12),
('Vintage Guitar', 'Rare 1950s electric guitar', 8000, NULL, '2024-12-10 10:30:00', NULL, 'Ongoing', 13),
('Rare Coin Collection', 'Collection of ancient and rare coins', 12000, NULL, '2024-12-15 13:00:00', NULL, 'Ongoing', 14),
('Antique Pocket Watch', 'Gold pocket watch from the 1800s', 3500, NULL, '2024-12-20 14:30:00', NULL, 'Ongoing', 15),
('Vintage Movie Poster Collection', 'Collection of classic movie posters', 2000, NULL, '2024-12-25 12:00:00', NULL, 'Ongoing', 16),
('Rare Vinyl Records', 'Collection of rare and first press vinyl records', 5000, NULL, '2024-12-30 11:00:00', NULL, 'Ongoing', 17),
('Antique Tea Set', 'Complete antique porcelain tea set', 1800, NULL, '2025-01-05 10:00:00', NULL, 'Ongoing', 18),
('Vintage Typewriter', 'Fully functional vintage typewriter', 1000, NULL, '2025-01-10 15:00:00', NULL, 'Ongoing', 19),
('Antique Map Collection', 'Collection of rare antique maps', 9000, NULL, '2025-01-15 14:00:00', NULL, 'Ongoing', 20);
...
('/images/football_jersey.jpg', 5),
('/images/antique_clock.jpg', 6),
('/images/designer_handbag.jpg', 9),
('/images/vintage_record_player.jpg', 10),
('/images/first_edition_book.jpg', 7),
('/images/limited_edition_sneakers.jpg', 8),
('/images/rare_stamps.jpg', 11),
('/images/antique_furniture.jpg', 12),
('/images/vintage_guitar.jpg', 13),
('/images/rare_coins.jpg', 14),
('/images/antique_pocket_watch.jpg', 15),
('/images/vintage_movie_posters.jpg', 16),
('/images/rare_vinyl_records.jpg', 17),
('/images/antique_tea_set.jpg', 18),
('/images/vintage_typewriter.jpg', 19),
('/images/antique_maps.jpg', 20);
